...
<script type="text/babel">
  ...
  function HelloComponent () {
    ...
    return (
        <div>
            <p className="something" onClick={() => {console.log('Clicked!');}}>Hello, World!</p>
            <p>Test</p>
        </div>
        );
  }
...
There is a command-line tool we can make use of to quickly generate React projects called "[Create React App](https://create-react-app.dev/)." This is a very powerful tool for starting work on a React application. It comes, out-of-the-box with amazing features like:
